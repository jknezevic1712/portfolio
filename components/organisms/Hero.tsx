			...
			<div className="flex flex-col">
				<div className="text-center lg:text-start">
					<div className="flex flex-col gap-2">
						<h2 className="text-highlight text-4xl font-medium md:text-5xl lg:text-3xl xl:text-4xl 2xl:text-5xl">
							{RESUME_DATA.name}
						</h2>
						<Anchor
							href={RESUME_DATA.locationLink}
							className="flex gap-1 items-center justify-center text-xs 2xl:text-sm 3xl:text-lg text-gray-800 lg:justify-start"
							underline
						>
							<CiGlobe />
				...
				<div className="flex justify-center gap-4 text-gray-600 lg:justify-start lg:gap-2">
